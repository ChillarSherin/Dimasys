...
class SaleBaseFragment : Fragment() {

    lateinit var binding: FragmentBaseSalesBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_base_sales, container, false)
        return binding.root
    }
